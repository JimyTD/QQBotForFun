...
HELP_TEXT = render.text_card(
    ...
    [
        ...
        "",
        "━━━ 🌊 深海任务 ━━━",
        "玩法：合作吃墩，按任务要求让对应玩家吃到目标墩/牌",
        "规则：必须跟首牌花色；没花色可垫牌；潜艇是将牌",
        "任务：机器人自动判定任务，最终完成后发送 胜利",
        "深海任务 N       创建 3-5 人任务房间，N 为总难度",
        "深海战役         官方 32 关战役（进度自动保存，含特殊符号）",
        "加入 · 重复加入 · 离开 · 开始/发牌",
        "选 2 · 出 蓝4 · 声呐 蓝4 最高",
        "公开预测群里发；秘密预测私聊发：预测 1 3",
        "胜利 · 失败",
        "",
        "━━━ 🌙 静夜标记 ━━━",
        "玩法：没有自由发言的狼人杀 —— 用「标记」代替发言，再投票放逐",
        "板子：12 套预设（4人标准 · 6人神职 · 7人 · 8人白狼王/骑士 …）",
        "静夜标记 [板子]   创建报名房间（省略板子 = 4 人标准）",
        "加入 · 重复加入 · 离开　|　房主：开始 · 板子 X · 踢人 N",
        "标记：@我 标记 好人 直觉判断 | 3号 狼人 标记分析 | …",
        "只发「@我 标记」可进入逐步引导（在私聊里带你）",
        "自己提前出局：回复「退出」　收掉整局：@我 结束（谁都行，不用房主）",
        "@我 记录   私聊看自己的身份与私有记录",
        "",
        "━━━ ⚔️ 帝国3斗蛐蛐 ━━━",
        "斗蛐蛐 [模式]     模式：单挑/乱斗/王中王/锦标赛",
        "斗蛐蛐 [预算]     预算 1000-50000（默认按时代）",
        "斗蛐蛐 预算 15000 设置本群默认预算",
        "斗蛐蛐 兵种A 兵种B  指定兵种对决",
        "斗蛐蛐 [N时代]    设定时代 2~5",
        "1 / 2             押注红/蓝方（普通模式）",
        "锦标赛押注 1-8    押注任意序号夺冠",
...
async def _(matcher: Matcher, event: MessageEvent) -> None:
    ...
    footer = [
        f"💰 金币：{coin}",
        "🎮 开始游戏：@我 海龟汤 / @我 趣味问答 / @我 深海任务 8 / @我 斗蛐蛐",
        "📜 @我 帮助 查看帮助",
    ]
