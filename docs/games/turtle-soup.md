...
| `@机器人 /提示` | 游戏中 | 花费金币揭示一条未发现的关键线索（每局限 3 次） |
...
| 汤底被提前泄露到群（通过购买提示过多） | 每局限购次数；提示只揭单条关键线索，不直接给完整汤底 |
...
| 版本 | 日期 | 变更 |
|---|---|---|
| 1.2 | 2026-05-09 | 新增 `/汤面` 指令：游戏中随时重新查看题面 |
| 1.1 | 2026-05-06 | 新增 `/提示` 指令：花金币揭示一条未发现的关键线索（每局限 3 次，5 coin/次） |
| 1.0 | 2026-04-28 | 初版设计 |
