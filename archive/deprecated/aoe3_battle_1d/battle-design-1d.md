# 帝国3电子斗蛐蛐 —— 旧一维设计快照（已废弃）

> **本文件已移出生产文档。** 它记录的是旧一维模拟器，仅用于创意参考与实现回溯。
> 当前二维规范见 `docs/games/aoe3-battle.md`，唯一生产实现见
> `src/plugins/games/aoe3_battle/simulator2d/`，不要按本文件恢复运行时开关。
